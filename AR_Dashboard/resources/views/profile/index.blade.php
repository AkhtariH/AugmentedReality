...
@section('content')
    ...
    <span class="text-secondary">Dashboard <i class="fa fa-angle-right"></i> Mein Profil</span>
                ...
                <div class="profile-bio-main container-fluid">
                    <div class="row">
                        <div class="col-md-5 offset-md-3 col-sm-12 offset-sm-0 col-12 bio-header">
                            <h3 class="mt-4">{{ $user->first_name }} {{ $user->last_name }} <a href="{{ route('profile.edit', $user->id) }}" style="vertical-align: middle;"><span style="font-size: 17px;margin-left: 10px;"><i class="fas fa-pencil-alt" style="vertical-align: text-top;"></i></span></a></h3>
