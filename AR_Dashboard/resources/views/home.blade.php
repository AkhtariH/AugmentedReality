            ...
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body text-white">
                        <h3 class="mb-0 text-white"><span class="counter ml-0">{{ $objectsCount }}</span></h3>
            ...
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body text-white">
                        ...
                        <small>{{ $objectsCount > 0 ? round(($approvedCount / $objectsCount) * 100, 2) : 0 }}%</small>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body text-white">
                        ...
                        <small>{{ $objectsCount > 0 ? round(($rejectedCount / $objectsCount) * 100, 2) : 0 }}%</small>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="basic-form custom_file_input">
                    <form action="{{ route('home.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="number" name="latitude" step="any" class="form-control" id="lat" placeholder="Latitude">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    <input type="number" name="longitude" step="any" class="form-control" id="long" placeholder="Longitude">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('home.simulator', $object->id) }}" class="dropdown-item">
                                                    Simulator
                                                </a>
...
var mymap = L.map('mapid', { zoomControl: false }).setView([52.217832, 6.897515], 20);

L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoiaHlsa2UzNSIsImEiOiJja3E5OW13eDIwM3QyMm9zMDViMDJ2MG13In0.kJkpjvdjcet0jpG-jKynWQ', {
